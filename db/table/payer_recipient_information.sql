...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 22, 2020 at 03:25 PM
...
--
-- Table structure for table `payer_recipient_information`
--

CREATE TABLE `payer_recipient_information` (
  `id` int(100) NOT NULL,
  ...
  `payer_state` varchar(100) NOT NULL,
  ...
  `recipient_country` int(11) NOT NULL,
  `recipient_zip` varchar(100) NOT NULL,
  `recipient_tin` int(100) NOT NULL
...
--
-- Indexes for table `payer_recipient_information`
--
ALTER TABLE `payer_recipient_information`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `payer_recipient_information`
--
ALTER TABLE `payer_recipient_information`
