...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 30, 2018 at 09:22 AM
...
--
-- Table structure for table `sales_tax_application`
--

CREATE TABLE `sales_tax_application` (
  `id` int(11) NOT NULL,
  ...
  `rt6_availability` varchar(100) NOT NULL,
  `rt6_number` varchar(100) NOT NULL,
...
--
-- Indexes for table `sales_tax_application`
--
...
--
-- AUTO_INCREMENT for table `sales_tax_application`
--
ALTER TABLE `sales_tax_application`
