        ...
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
                <a class="btn btn-success btn-xs" href="javascript:void(0);"
                   onclick="show_marketing_main_cat_modal('add', '');"><i class="fa fa-plus"></i> Add Main Category</a>
                            ...
                            if (isset($main_cat_list) && count($main_cat_list) > 0) {
                                foreach ($main_cat_list as $value) {
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="javascript:void(0);" class="editmodal edit_service" onclick="show_marketing_main_cat_modal('edit', '<?= $value['id']; ?>');" title="EDIT"><i class="fa fa-edit"></i></a>&nbsp;
                                            <a href="javascript:void(0);" title="DELETE" onclick="delete_marketing_main_cat('<?= $value['id'] ?>');"><i class="fa fa-trash"></i></a>
                                        </td>
                                    </tr>
                                    <?php
                                }
