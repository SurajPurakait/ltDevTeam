    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
                <form class="form-horizontal" method="post" id="form_create_legal_translations">
                    <div class="ibox-content">
                        ...
                        <div class="form-group">
                            <label class="col-lg-2 control-label">Translation To<span class="text-danger">*</span></label>
                            <div class="col-lg-10">
