        ...
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
                <div class="ibox-content">
                    <form class="form-horizontal" method="post" id="related_create_sales_tax_application" onsubmit="related_create_sales_tax_application(); return false;">
                    ...
                    <div class="rt6-div ibox-content bg-2">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-10">
                                <label class="radio-inline"><input <?php if(isset($sales_tax_data['rt6_availability'])){echo $sales_tax_data['rt6_availability'] == "Yes" ? "checked='checked'" : "";} ?> type="radio" name="Rt6" value="Yes" id="Rt6_1" required="">Yes</label>
                                <label class="radio-inline"><input <?php if(isset($sales_tax_data['rt6_availability'])){echo $sales_tax_data['rt6_availability'] == "No" ? "checked='checked'" : "";} ?> type="radio" name="Rt6" value="No" id="Rt6_2" required="">No</label>
                        ...
                        <div class="rt6yes" <?php if(isset($sales_tax_data['rt6_availability'])){ echo $sales_tax_data['rt6_availability'] != "Yes" ? "style='display:none;'" : ""; } else { echo "style='display:none;'"; } ?>>
                            <div class="form-group">
                                <label class="col-lg-2 control-label">RT-6 Number<span class="text-danger">*</span></label>
                                <div class="col-lg-10">
                                    <input placeholder="" class="form-control" type="text" name="rt6_number" id="rt6_number" title="RT-6 Number" value="<?php if(isset($sales_tax_data['rt6_number'])){echo $sales_tax_data['rt6_number'];} ?>">
                                    <div class="errorMessage text-danger"></div>
                                </div>
                            </div>
                            <div class="form-group">
                        ...
                        <div class="rt6no" <?php if(isset($sales_tax_data['rt6_availability'])) { echo $sales_tax_data['rt6_availability'] != "No" ? "style='display:none;'" : ""; } else { echo "style='display:none;'"; } ?>>
                            <div class="form-group">
                    ...
                    <div class="hr-line-dashed"></div>
                        ...
                        <div class="form-group">
                            <div class="col-lg-offset-2 col-lg-10">
                                ...
                                <button class="btn btn-success" type="button" onclick="related_create_sales_tax_application('related_create_sales_tax_application')">Save changes</button> &nbsp;&nbsp;&nbsp;
                                <button class="btn btn-default" type="button" onclick="cancelRelatedServiceForm('related_create_sales_tax_application')">Cancel</button>
                            </div>
                        </div>
                    </form>
                </div>
