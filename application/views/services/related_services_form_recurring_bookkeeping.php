        ...
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
                <div class="ibox-content">
                    <form class="form-horizontal" method="post" id="related_create_recurring_bookkeeping" onsubmit="related_create_recurring_bookkeeping(); return false;">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-10">
                                <input placeholder="" numeric_valid="" class="form-control" type="text" id="retail_price_override" name="retail_price_override" title="Retail Price" value="<?php echo $override_price; ?>">
                                <div class="errorMessage text-danger"></div>
                            </div>
                        </div>
                        <div class="hr-line-dashed"></div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-10">
                                <select class="form-control frequeny_of_bookkeeping" name="frequeny_of_bookkeeping" id="frequeny_of_bookkeeping" title="Frequency Of Bookkeeping" required>
                                    <option value="" <?php echo $bookkeeping_data['frequency']=='' ? 'selected' : ''; ?>>Select</option>
                                    <option value="m" <?php echo $bookkeeping_data['frequency']=='m' ? 'selected' : ''; ?>>Monthly</option>
                                    <option value="q" <?php echo $bookkeeping_data['frequency']=='q' ? 'selected' : ''; ?>>Quarterly</option>
                                    <option value="y" <?php echo $bookkeeping_data['frequency']=='y' ? 'selected' : ''; ?>>Yearly</option>
                                </select>
                                <div class="errorMessage text-danger"></div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <div class="col-lg-offset-2 col-lg-10">
                                ...
                                <button class="btn btn-success" type="button" onclick="related_create_recurring_bookkeeping('related_create_recurring_bookkeeping')">Save changes</button> &nbsp;&nbsp;&nbsp;
                                <button class="btn btn-default" type="button" onclick="cancelRelatedServiceForm('related_create_recurring_bookkeeping')">Cancel</button>
                            </div>
                        </div>
                    </form>
                </div>
