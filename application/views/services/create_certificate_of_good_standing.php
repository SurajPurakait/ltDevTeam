    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="ibox float-e-margins">                
                <form class="form-horizontal" method="post" id="form_create_certificate_of_good_standing" onsubmit="request_create_certificate_of_good_standing(); return false;">
                    <div class="ibox-content">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-10">
                                <select class="form-control type_of_client" name="type_of_client" id="type_of_client_ddl" onchange="clientTypeChange(this.value, <?= $reference_id; ?>, '<?= $reference; ?>', 1);changeService(getIdVal('state'), '<?= $service_id; ?>', '<?= $service_info['retail_price']; ?>', '<?= $service_id_fl; ?>', '<?= $service_info_fl['retail_price']; ?>');change_retail_price('','');" title="Type Of Client" required>
                        ...
                        <div class="form-group client_type_div0" id="client_list">
                            ...
                            <div class="col-lg-10">
                                <select class="form-control client_list client_type_field0" name="client_list" id="client_list_ddl" title="Client List" onchange="fetchExistingClientData(this.value, <?= $reference_id; ?>, '<?= $reference; ?>', 1);changeService(getIdVal('state'), '<?= $service_id; ?>', '<?= $service_info['retail_price']; ?>', '<?= $service_id_fl; ?>', '<?= $service_info_fl['retail_price']; ?>');change_retail_price('',this.value);">
                                </select>
                                <div class="errorMessage text-danger"></div>
                            </div>
                        </div>
                        ...
                        <div class="form-group" id="state_div">
                            ...
                            <div class="col-lg-10">
                                <select class="form-control value_field required_field disabled_field" name="state" id="state" title="State of Incorporation" required="" onclick="changeService(this.value, '<?= $service_id; ?>', '<?= $service_info['retail_price']; ?>', '<?= $service_id_fl; ?>', '<?= $service_info_fl['retail_price']; ?>');select_other_state(this.value);">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-10">
                                <input id="retail_price" readonly="" placeholder="" class="form-control" type="text" title="Retail Price" value="0">
                                <input name="retail_price" id="retail_price_hdn" type="hidden" value="0">
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <?php service_note_func('Note', 'n', 'company'); ?>
                        <div class="hr-line-dashed"></div>
                        <h3>Confirmation</h3>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <div class="col-lg-offset-2 col-lg-10">
                                ...
                                <button class="btn btn-success" type="button" onclick="request_create_certificate_of_good_standing();">Save changes</button> &nbsp;&nbsp;&nbsp;
...
<script>
    ...
    function change_retail_price(value,ref_id){
            $.ajax({
            type: "POST",
            data: {value: value,ref_id: ref_id},
            url: base_url + 'services/Incorporation/change_retail_price',
            dataType: "html",
            success: function (result) {
               changeService(result.trim(), '<?= $service_id; ?>', '<?= $service_info['retail_price']; ?>', '<?= $service_id_fl; ?>', '<?= $service_info_fl['retail_price']; ?>');
            },
            beforeSend: function () {
                openLoading();
            },
