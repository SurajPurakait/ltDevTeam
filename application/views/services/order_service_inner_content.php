                ...
                foreach ($services_list as $keys => $row_inner) {
                    ...
                    if ($status_rt6_val == 'Yes') { //check rt6 start
                        ...
                        <tr <?= ( strtotime($row_inner->date_completed) < strtotime(date('Y-m-d')) ) ? "class='text-danger'" : ""; ?>>
                            ...
                            if ($service_id == '11') {
                                if ($row_inner->service_id == '11') {
                                    echo "<td align='center' title=\"Notes\"><span>" . (($note_count_inner > 0) ? '<a id="orderservice-' . $row_inner->service_id . '" count="' . $note_count_inner . '" class="label label-warning" href="javascript:void(0)" onclick="show_notes(\'payrollemp\',\'' . $row_inner->service_request_id . '\',\'' . $row_inner->service_id . '\',\'' . $reference_id . '\',\'' . $order_id . '\')"><b>' . $note_count_inner . '</b></a>' : '<a id="orderservice-' . $row_inner->service_id . '" count="' . $note_count_inner . '" class="label label-warning" href="javascript:void(0)" onclick="show_notes(\'payrollemp\',\'' . $row_inner->service_request_id . '\',\'' . $row_inner->service_id . '\',\'' . $reference_id . '\',\'' . $order_id . '\')"><b>' . $note_count_inner . '</b></a>') . "</span></td>";
                                } else {
                                    echo "<td align='center' title=\"Notes\"><span>" . (($note_count_inner > 0) ? '<a id="orderservice-' . $row_inner->service_id . '" count="' . $note_count_inner . '" class="label label-warning" href="javascript:void(0)" onclick="show_notes(\'payrollrt6\',\'' . $row_inner->service_request_id . '\',\'' . $row_inner->service_id . '\',\'' . $reference_id . '\',\'' . $order_id . '\')"><b>' . $note_count_inner . '</b></a>' : '<a id="orderservice-' . $row_inner->service_id . '" count="' . $note_count_inner . '" class="label label-warning" href="javascript:void(0)" onclick="show_notes(\'payrollrt6\',\'' . $row_inner->service_request_id . '\',\'' . $row_inner->service_id . '\',\'' . $reference_id . '\',\'' . $order_id . '\')"><b>' . $note_count_inner . '</b></a>') . "</span></td>";
                                }
                            } else {
                                echo "<td align='center' title=\"Notes\"><span>" . (($note_count_inner > 0) ? '<a id="orderservice-' . $row_inner->service_id . '" count="' . $note_count_inner . '" class="label label-warning" href="javascript:void(0)" onclick="show_notes(\'service\',\'' . $row_inner->service_request_id . '\',\'' . $row_inner->service_id . '\',\'' . $reference_id . '\',\'' . $order_id . '\')"><b>' . $note_count_inner . '</b></a>' : '<a id="orderservice-' . $row_inner->service_id . '" count="' . $note_count_inner . '" class="label label-warning" href="javascript:void(0)" onclick="show_notes(\'service\',\'' . $row_inner->service_request_id . '\',\'' . $row_inner->service_id . '\',\'' . $reference_id . '\',\'' . $order_id . '\')"><b>' . $note_count_inner . '</b></a>') . "</span></td>";
                            }
                            ?>
