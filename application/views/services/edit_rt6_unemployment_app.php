    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
                <form class="form-horizontal" method="post" id="form_create_rt6_unemployment_app" onsubmit="request_create_rt6_unemployment_app(); return false;">
                    ...
                    <div class="rt6-div ibox-content bg-2">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-10">
                                <label class="radio-inline"><input <?= $sales_tax_data['salestax_availability'] == "Yes" ? "checked='checked'" : ""; ?> type="radio" name="Rt6" value="Yes" id="Rt6_1" required="">Yes</label>
                                <label class="radio-inline"><input <?= $sales_tax_data['salestax_availability'] == "No" ? "checked='checked'" : ""; ?> type="radio" name="Rt6" value="No" id="Rt6_2" required="">No</label>
                        ...
                        <div class="rt6yes" <?= $sales_tax_data['salestax_availability'] != "Yes" ? "style='display:none;'" : ""; ?>>
                            <div class="form-group">
                                <label class="col-lg-2 control-label">RT-6 Number<span class="text-danger">*</span></label>
                                <div class="col-lg-10">
                                    <input placeholder="" class="form-control" type="text" name="rt6_number" id="rt6_number" title="RT-6 Number" value="<?= $sales_tax_data['salestax_number']; ?>">
                                    <div class="errorMessage text-danger"></div>
                                </div>
                            </div>
                            <div class="form-group">
                        ...
                        <div class="rt6no" <?= $sales_tax_data['salestax_availability'] != "No" ? "style='display:none;'" : ""; ?>>
                            <div class="form-group">
                        ...
                        <div class="residentclass" <?= $sales_tax_data['resident_type'] != "Resident" ? "style='display:none;'" : ""; ?>>
                            <div class="form-group">
                                ...
                                <div class="col-lg-10">
                                    <label>Upload Drivers License of All Owners (jpg,jpeg,gif,png,pdf)<span class="text-danger">*</span></label>
                    ...
                    <div class="ibox-content">
                        ...
                        <div class="form-group">
                            <div class="col-lg-offset-2 col-lg-10">
                                ...
                                <button class="btn btn-success" type="button" onclick="request_create_rt6_unemployment_app()">Save changes</button> &nbsp;&nbsp;&nbsp;
                                <button class="btn btn-default" type="button" onclick="cancelRequestCreateRt6UnemploymentAapp()">Cancel</button>
                            </div>
                        </div>
                    </div>
                </form>
