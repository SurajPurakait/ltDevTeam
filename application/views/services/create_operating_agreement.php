                ...
                <form class="form-horizontal" method="post" id="form_create_operating_agreement" onsubmit="request_create_operating_agreement(); return false;">
                    <div class="ibox-content">
                        ...
                        <div class="form-group" id="existing-check-div">
                            ...
                            <div class="col-lg-10">
                                <select class="form-control type_of_client" name="type_of_client" id="type_of_client_ddl" onchange="clientTypeChange(this.value, <?= $reference_id; ?>, '<?= $reference; ?>', 1);modify_retail_price('','');" title="Type Of Client" required>
                        ...
                        <div class="form-group client_type_div0" id="client_list">
                            ...
                            <div class="col-lg-10">
                                <select class="form-control client_list client_type_field0" name="client_list" id="client_list_ddl" title="Client List" onchange="fetchExistingClientData(this.value, <?= $reference_id; ?>, '<?= $reference; ?>', 1);modify_retail_price('',this.value);">
                                </select>
                                <div class="errorMessage text-danger"></div>
                            </div>
                        </div>
                        ...
                        <div class="form-group" id="type_div">
                            ...
                            <div class="col-lg-10">
                                <select class="form-control value_field required_field disabled_field" name="type" id="type" title="Type of Company" required="" onchange="modify_retail_price(this.value,'<?php echo $reference_id; ?>');">
                                    <option value="">Select an option</option>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-10">
                                ...
                                <input name="retail_price" type="hidden" value="0">
                                <input name="retail_price_llc" type="hidden" value="<?= $service_info['retail_price']; ?>">
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-10">
                                <input placeholder="dd/mm/yyyy" id="doc_date" class="form-control datepicker_mdy" type="text" title="Document Date" name="doc_date" value="">
                                <div class="errorMessage text-danger"></div>
                            </div>
                        </div>
                        <h3>Confirmation</h3>
    ...
    function modify_retail_price(value,ref_id){
    	if(value=='' && ref_id==''){
            ...
            complete: function (msg) {
                ...
                var rp = $("input[name='retail_price_llc']").val();
                $("#retail_price").val(rp);
