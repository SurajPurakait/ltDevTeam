    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
                <form class="form-horizontal" method="post" id="form_create_company_non_profit_fl" onsubmit="request_create_company_non_profit_fl();return false;">
                    <div class="ibox-content">
                        ...
                        <div class="form-group">
                            <label class="col-lg-2 control-label">Activity<span class="text-danger">*</span></label>
                            <div class="col-lg-10">
                                <textarea class="form-control" name="activity" id="activity" title="Activity"></textarea>
                                <div class="errorMessage text-danger"></div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <div class="col-lg-offset-2 col-lg-10">
                                ...
                                <button class="btn btn-success" type="button" onclick="request_create_company_non_profit_fl()">Save changes</button> &nbsp;&nbsp;&nbsp;
