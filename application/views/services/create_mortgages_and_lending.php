					...
					<div class="ibox-content">
						...
						<div class="form-group">
							...
							<div class="col-lg-10">
								<select class="form-control" id="assigned_to" name="assigned_to" required="">
									...
									?>
										<option value="<?= $apl['p_id']; ?>"><?= $apl['first_name'] . ' ' . $apl['last_name']; ?></option>
									<?php
									}
									?>
								</select>
						...
						<div class="form-group">
							<div class="col-lg-offset-2 col-lg-10">
								...
								<input type="hidden" name="partner_service_name" id="partner_service_name" value="mortgage_and_lending">
