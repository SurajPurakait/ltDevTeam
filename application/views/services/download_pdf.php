    ...
    if ($service_id == '10' || $service_id == '41') {
     ...
     $content .=   '<table class="table table-striped" style="width:100%;">
           ...
           $content .= '<tr>
            ...
            if ($get_bookkeeping[0]['existing_practice_id'] != '') { 
                $content .= '<tr>
                    <td style="padding: 8px;line-height: 1.42857143;vertical-align: top;border-top: 1px solid #ddd;">
...
//                 } 
              ...
              $content .= '<tr>';
                ...
                if ($payroll_account_numbers['lease'] != "") {
                ...
                if ($payroll_company_data['fein_filename'] != "") {
  ...
  elseif ($service_id == '12') {
      ...
      $content .= '<table class="table table-striped" style="width:100%;">
            ...
            $acctype1 = ($sales_tax_data['acc_type1']==0) ? "Personal" : "Business";
            $acctype2 = ($sales_tax_data['acc_type2']==0) ? "Checking" : "Savings";
            $content .= '<tr>
                <td style="padding: 8px;line-height: 1.42857143;vertical-align: top;border-top: 1px solid #ddd;">Account Type 1:
                </td>
                <td style="padding: 8px;line-height: 1.42857143;vertical-align: top;border-top: 1px solid #ddd;">'.$acctype1.'</td>
            </tr>
            <tr>
                <td style="padding: 8px;line-height: 1.42857143;vertical-align: top;border-top: 1px solid #ddd;">Account Type 2:
                </td>
                <td style="padding: 8px;line-height: 1.42857143;vertical-align: top;border-top: 1px solid #ddd;">'.$acctype2.'</td>
            </tr>
            <tr>
                <td style="padding: 8px;line-height: 1.42857143;vertical-align: top;border-top: 1px solid #ddd;">Do you
                    have a RT-6 #?:
        ...
        $content .= '<tr>
            <td style="padding: 8px;line-height: 1.42857143;vertical-align: top;border-top: 1px solid #ddd;">Existing Practise Id:
            </td>
        ...
        $content .= '<tr>';
               ...
               $content .='</td></tr>';
                ...
                if ($sales_tax_data['void_cheque'] != "" && file_exists($sales_tax_data['void_cheque'])) {
                 ...
                 if ($sales_tax_data['passport'] != "" && file_exists($sales_tax_data['passport'])) {
                    $content .= '<tr><td style="padding: 8px;line-height: 1.42857143;vertical-align: top;border-top: 1px solid #ddd;">Passport:</td>';
                    $content .= '<td style="padding: 8px;line-height: 1.42857143;vertical-align: top;border-top: 1px solid #ddd;">';
  ...
  elseif($service_id==47){
            ...
            <td style="padding: 8px;line-height: 1.42857143;vertical-align: top;border-top: 1px solid #ddd;">' . $recurring_data->sales_tax_id . '
                ...
                $content .= '<tr>
            <td style="padding: 8px;line-height: 1.42857143;vertical-align: top;border-top: 1px solid #ddd;">Sales Tax Password:
            </td>
          ...
          if($recurring_data->freq_of_salestax=='m'){
              $freqval = "Monthly";
          }elseif ($recurring_data->freq_of_salestax=='q') {
            $freqval = "Quarterly";
        } else{
            $freqval = "Yearly";
        }      
           ...
           Frequency Of Salestax:
            ...
            <td style="padding: 8px;line-height: 1.42857143;vertical-align: top;border-top: 1px solid #ddd;">' . $freqval . '
            </td>
        </tr>';
           ...
           State Of Recurring:
            ...
            <td style="padding: 8px;line-height: 1.42857143;vertical-align: top;border-top: 1px solid #ddd;">' . state_info($recurring_data->state)['state_name'] . '
            </td>
        </tr>';
           ...
           County Of Recurring:
            ...
            <td style="padding: 8px;line-height: 1.42857143;vertical-align: top;border-top: 1px solid #ddd;">' . county_info($recurring_data->county)['name'] . '
            </td>
        </tr>';
...
//                $content.='</tr>';
          ...
          if(count($documents)!=0){
                $content .= '<tr>'
                        . '<td style="padding: 8px;line-height: 1.42857143;vertical-align: top;border-top: 1px solid #ddd;">Document:</td>';
                $content .= '<td style="padding: 8px;line-height: 1.42857143;vertical-align: top;border-top: 1px solid #ddd;">';
                foreach ($documents as $d) {
                    $content .= '<a href=' . base_url() . '/uploads/' . $d['document'] .'>' . $d['document'] . '</a><br>';
                }
