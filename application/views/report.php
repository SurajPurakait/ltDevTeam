                ...
                <div class="ibox-content">
                    ...
                    <div class="row">
                        <div class="col-lg-9 m-t-20">
                            <div class="row"> 
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <label class="col-lg-4 m-t-5 control-label">Select Period :</label>
                                        <div class="col-lg-8">
                                ...
                                <div class="col-lg-6"> <div class="form-group">
                                        <label class="col-lg-3 m-t-5 control-label">Office :</label>
                                        <div class="col-lg-9">
                                            <select class="form-control" name="" id="s" title="S"  required="">
                            ...
                            <button type="button" class="btn btn-default pull-right m-t-20">Export</button>
