                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <label class="checkbox-inline">
                                <input class="checkclass" value="y" type="radio" id="task_inputform1" name="task[is_input_form]" required title="Input Form" <?= ($task_details->input_form_status == 'y') ? 'checked' : ''; ?>> Yes
                            </label>
                            <label class="checkbox-inline">
                                <input class="checkclass" value="n" type="radio" id="task_inputform2" name="task[is_input_form]" required title="Input Form" <?= ($task_details->input_form_status == 'n') ? 'checked' : ''; ?>> No
                            </label>
                            <div class="errorMessage text-danger"></div>
                        </div>
                    </div>
