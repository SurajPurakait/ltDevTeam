                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <label class="control-label"><input type="radio" <?php echo ($task_details->target_start_day==2) ? 'checked' : ''; ?> name="task[target_start_day]" value="2">&nbsp; Days before due date</label>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
