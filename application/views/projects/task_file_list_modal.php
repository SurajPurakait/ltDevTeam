...
<?php
                    ...
                    ?>
                    <form name="file_upload" method="POST" id="file_upload_task_modal">
                        ...
                        <button class="btn btn-info m-t-10 upload-file-butt" type="button" onclick="file_upload_task()">Upload</button>
                    </form>
