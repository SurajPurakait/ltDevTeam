        ...
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
                <a class="btn btn-success btn-xs" href="javascript:void(0);"
                   onclick="show_sub_cat_modal('add', '');"><i class="fa fa-plus"></i> Add Sub Category</a>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="javascript:void(0);" class="editmodal edit_service"
                                           onclick="show_sub_cat_modal('edit', '<?php echo $value['id']; ?>');"
                                           title="EDIT"><i
                                                    class="fa fa-edit"></i></a>&nbsp;
                                        <a href="javascript:void(0);" title="DELETE"
                                           onclick="delete_sub_cat('<?php echo $value['id'] ?>');"><i
