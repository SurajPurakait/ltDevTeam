                ...
                <div class="ibox-content">
                    <form class="form-horizontal" method="post" id="form_save_lead_mail" onsubmit="save_lead_mail(); return false;">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-10">
                                <input placeholder="Schedule Date" id="schedule_date" required class="form-control" type="text" name="schedule_date" title="Schedule Date" value="<?php echo date('m/d/Y', strtotime($edit_lead_mail_content['schedule_date'])); ?>">
                                <div class="errorMessage text-danger"></div>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <div class="col-lg-offset-2 col-lg-10">
                                <input type="hidden" name="email_id" value="<?php echo $edit_lead_mail_content['id']; ?>">
