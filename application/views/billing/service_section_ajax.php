...
<div class="well <?php echo $colors[$random_keys]; ?>" id="service_result_div_<?= $section_id; ?>">
    <div class="form-group" id="category_div_<?= $section_id; ?>">
        ...
        <div class="col-lg-10">
            <select class="form-control" name="service_section[<?= $section_id; ?>][category_id]" onchange="getServiceDropdownByCategory(this.value, '<?= $service_id ?>', '<?= $section_id; ?>','<?= $invoice_type; ?>');" id="category_<?= $section_id; ?>" title="Service Category" required="">
