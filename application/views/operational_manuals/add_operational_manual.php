        ...
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
                <div class="ibox-content">
                    <form class="form-horizontal" method="post" id="form_add_operaional_manual">
                        <h3>Add New Operational Manual</h3>
                        
                        
                        <div class="form-group">
                            <label class="col-lg-2 control-label">Title<span class="text-danger">*</span></label>
                            <div class="col-lg-10">
                                <input class="form-control" required type="text" required title="Title" id="title" name="title">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-10">
                                <select  class="form-control"  title="Main Category" name="main_cat" id="main_cat" required onchange="get_operational_manual_sub_cats()">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-10 subcat">
                                <select  class="form-control"  title="Sub Category" name="sub_cat" id="sub_cat">
                                    <option value="">Select</option>
                                </select>
                                <div class="errorMessage text-danger"></div>
                            </div>
                        ...
                        <div class="form-group">
                            <div class="col-lg-offset-2 col-lg-10">
                                <button class="btn btn-success save_btn" type="button" onclick="add_operational_manual()">
                                    Save Changes
                                </button> &nbsp;&nbsp;&nbsp;
