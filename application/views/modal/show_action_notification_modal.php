<div style="height:480px; overflow-y: scroll">
    ...
    foreach ($general_notification_list as $notification_index => $gnl) {
        ...
        <div class="feed-element notification-item notification-<?= $gnl['reference']; ?> notification-<?= ($notification_index > 4) ? 'hide' : 'show'; ?> notification-<?= $diff_text; ?>" id="notification-div-<?= $gnl['id']; ?>">
            ...
            <a href="javascript:void(0);" onclick="readActionNotification('<?= $gnl['id']; ?>','action');document.getElementById('notification-div-<?= $gnl['id']; ?>').remove();" class="pull-right text-muted p-5 p-t-0"><i class="fa fa-times"></i></a>
            <?php endif; ?>
            <a class="media-body" href="<?php echo base_url(); ?>action/home/view_action/<?php echo $gnl['reference_id']; ?>">
