        ...
        <form class="form-horizontal" method="post" id="form_order_modal" onsubmit="return false;">
            <div class="modal-body">
                <div class="form-group">
                    ...
                    <div class="col-lg-9">
                        <select id="order_staff" name="staff" class="form-control" id="order_staff" title="Staff">
            ...
            <div class="modal-footer">
                <button class="btn btn-success" type="button" onclick="assignOrder(<?= $order_id ?>, getIdVal('order_staff'))">Assign</button> &nbsp;&nbsp;&nbsp;
