<?php if ($modal_type != "edit"): ?>
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form id="add-marketing-main-cat-form" name="add-marketing-main-cat-form">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" type="text" title="Category Icon" name="icon" id="main_cat_icon" required>
                        <div class="errorMessage text-danger"></div>
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                    <button type="button" class="btn btn-primary" onclick="add_marketing_main_cat()">Save
                        Changes
                    </button>
                </div>
            </form>
...
<?php else: ?>
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form id="edit-marketing-main-cat-form" name="edit-marketing-main-cat-form">
                <div class="modal-body">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                    <button type="button" class="btn btn-primary" onclick="edit_marketing_main_cat()">Save
                        Changes
                    </button>
                </div>
            </form>
