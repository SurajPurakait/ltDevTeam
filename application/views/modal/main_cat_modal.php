<?php if ($modal_type != "edit"): ?>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form id="add-main-cat-form" name="add-main-cat-form">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary" onclick="add_main_cat()">Save Changes</button>
                </div>
            </form>
        </div>
    </div>
<?php else: ?>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form id="edit-main-cat-form" name="edit-main-cat-form">
                <div class="modal-body">                    
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                    <button type="button" class="btn btn-primary" onclick="edit_main_cat()">Save
                        Changes
                    </button>
                </div>
            </form>
