                ...
                <tr>
                    <td>
                      ...
                      <?php if ($data['user_id'] == $this->session->userdata('user_id')) { ?>
                        ...
                        <p><span class="text-info"><b>By:</b> <?= $data['staff_name']; ?> </span> | <span class="text-warning"><b>Time:</b> <?= $data['time']; ?></span> | <span class="text-success"><b>Department:</b> <?= (staff_department_name($data['user_id'])!='') ? staff_department_name($data['user_id']) : 'Referral Partner'; ?></span></p>
                        <?php } else { ?>
