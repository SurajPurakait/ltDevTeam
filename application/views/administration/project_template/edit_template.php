                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="Id" title="Id" name="template_main[Id]" required value="<?= $template_details->template_id ?>">
                                                    <div class="errorMessage text-danger"></div>
                                                </div>
                                            </div><!-- col-md-6 -->
                                            <div class="col-md-6">
...
//                                                        endforeach;
                                        ...
                                        <?php $periodic_pattern= get_periodic_pattern($template_details->id); ?>
                                        <h3>Generation:</h3>
                                        <div class="row">
                                            <div class="col-md-12">
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-6">
                                                                    ...
                                                                    <div class="form-group" id='weekend_val'>
                                                                    ...
                                                                    <div class="form-group">
                                                                        <div class="form-inline due-div">
                                                                            ...
                                                                            <?php }elseif($pattern_details->pattern == 'periodic'){ ?>
                                                                                ...
                                                                                <input class="form-control m-b-5" type="number" name="recurrence[due_day]" min="1" max="31" style="width: 100px" id="r_day" value="<?php echo $pattern_details->due_day; ?>">
                                                                                <label class="control-label m-b-5">of month</label>&nbsp;
                                                                                ...
                                                                                <a href="javascript:void(0);" onclick="addPeriodicDate()" class="add-filter-button btn btn-primary" data-toggle="tooltip" data-placement="top" title="Add Periodic Date"> <i class="fa fa-plus" aria-hidden="true"></i> </a>
                        ...
                        <div role="tabpanel" id="tab-2" class="tab-pane">
                            <div class="panel-body">
                                <div class="clearfix">
                                    <button type="button" class="btn btn-primary pull-right m-b-20" id="task_btn" onclick="get_template_task_modal(<?= $template_details->id ?>);"><i class="fa fa-plus"></i> &nbsp;Create Task</button>
                                        ...
                                        foreach ($task_list as $keys=> $value) {
                                            ...
                                            <div class="panel panel-default service-panel type2 filter-active" id="action<?= $value['id'] ?>">
                                                <div class="panel-heading">
                                                    <a href="javascript:void(0);" onclick="tetmplate_task_edit_modal(<?= $value['id'] ?>,'<?= $template_details->id ?>');" class="btn btn-primary btn-xs btn-service-edit btn-prj-template-edit"><i class="fa fa-pencil" aria-hidden="true"></i> Edit</a>                                
                                                    <a href="javascript:void(0);" onclick="tetmplate_task_delete_modal(<?= $value['id']?>,<?= $value['template_main_id'] ?>);" class="btn btn-danger btn-xs btn-service-edit btn-prj-template-delete"><i class="fa fa-trash-o" aria-hidden="true"></i> Delete</a>
...
<?php
$office_staff = getTemplateOfficeStaff($template_details->id);
if (!empty($office_staff)) {
    $staff_id = $office_staff->staff_id;
} else {
    $staff_id = '';
}
$dept_staff = getTemplateDepartmentStaff($template_details->id);
if (!empty($dept_staff)) {
...
?>
<script>
//    change_due_pattern('<? $pattern_details->pattern ?>');
