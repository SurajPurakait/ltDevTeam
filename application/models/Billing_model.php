...
//        echo $this->db->last_query();die;
    ...
    public function refresh_report_dashboard_billing() {
        $select = [
            'inv.id as invoice_id',
            'inv.created_by AS created_by',
        ...
        $this->db->query('SET SQL_BIG_SELECTS=1');
        $billing_reports_data = $this->db->query($query)->result_array();
        
        foreach ($billing_reports_data as $brd) {
            ...
            $bqr = $this->db->query($billing_sql)->row_array();
